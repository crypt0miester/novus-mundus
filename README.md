...
Game Development: Novus Mundus also wants to encourage game development and reward developers who contribute to the game's growth. Novi tokens can be awarded to developers who contribute to game development and to those who report bugs through the bug bounty program. This not only incentivizes players to improve the game but also rewards their efforts, creating a collaborative and thriving community.
...
* 10_000_000 novi = 420 sol = 0.000042 novi/sol
 ...
 ## Subscriptions
    ...
    - Expert	: 2X 	Novi/Minute = 4 Sol
    - Epic		: 10X	Novi/Minute = 10 Sol
    - Legendary	: 50X    Novi/Minute = 39 Sol

## Novus Tiers (Initial Round Values)
Novi can be added to the round even if max Novi has been reached. but no more Novi will be generated after the max amount has reached.
 ### 1. Rookie: Default player (0.1 sol start)

  	- Networth $100_000_000
  	- DUs: 10_000, 10_000, 10_000
  	- OPs: 10_000, 10_000, 10_000
  	- Produce: 100_000
  	- Weapons: 30_000
  	- Max Novi: 3_000
  	- Novi/Minute: 10 
 ...
 ### 4. Legendary: Four stars
  	...
  	- OPs: 100_000, 100_000, 300_000
  	- Produce: 10_000_000
  	- Weapons: 500_000
  	- Max Novi: 150_000 
  	- Novi/Minute: 500
* Novi maxes out in 5 hours.
...
## NFTs (Techonology) in v0.5: 
      ...
      * Has a utility of 2
      * bonus novi: 80_000
      * max kills = 200_000 Units per user (both DUs and OPs)
      * F22 kills 50% more
      * B2 kills 75% more and is undetected. By iron dome.
      ...
      * bonus novi: 50_000
      * only 80% of nuclear is effective
