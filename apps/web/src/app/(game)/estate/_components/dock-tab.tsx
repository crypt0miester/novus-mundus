...
export function DockTab() {
  ...
  const forecast = ge
    ? forecastCollect(noviToDeci(collectNoviAmount), "fishing", player, ge, now)
    : null;
  ...
  return (
    <FeatureLayout
      main={
        <>
          <BuildingShowcase buildingId={BuildingId.Dock} icon="buff-fishing-affinity" />
            ...
            <div className="space-y-3">
              ...
              <ActivityForecast activity={ActivityType.Consuming} verb="Fishing">
                {operativeUnits > 0 && forecast ? (
                  ...
                  <span className="text-text-muted">Hire operative units to start fishing.</span>
                )}
              </ActivityForecast>
