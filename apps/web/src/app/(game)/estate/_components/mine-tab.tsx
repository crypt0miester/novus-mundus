...
export function MineTab() {
  ...
  const gems = Number(player.gems ?? 0n);
  ...
  const forecast = ge
    ? forecastCollect(noviToDeci(collectNoviAmount), "mining", player, ge, now)
    : null;
  ...
  return (
    <FeatureLayout
      main={
        <>
          <BuildingShowcase buildingId={BuildingId.Mine} icon="resource-gem" />
