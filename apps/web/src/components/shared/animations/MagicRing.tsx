...
export default function MagicRings({
  ...
  // Keep the latest props in a ref for the rAF loop, updated after commit so
  // the render phase stays side-effect free.
  useEffect(() => {
    propsRef.current = {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      // setPixelRatio before setSize — setSize multiplies by the current ratio.
