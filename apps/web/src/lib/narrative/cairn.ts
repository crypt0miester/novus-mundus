...
const MEDIEVAL: CairnContent = {
  ...
  beats: {
    ...
    oath: "The oath is spoken. What a House gives is never a gift — it is given, and given is owed. You are sworn. From here the stone marks you, not only your walls.",
    actThree:
    ...
    everyReturn: "You are back. The holding kept turning while you were gone.",
    level1Stall:
      "You grow by walking the road, and by the fight, and by what is hauled out of the dark. Not by raising walls.",
    incomingThreat: "A banner on the road, and it is not yours. It points to this gate.",
    incomingThreatMany: "Banners on the road, and none of them yours. They point to this gate.",
    incomingRally:
      "A host is forming, and you are the reason it forms. Its road ends at this gate.",
    incomingRallyMany: "Hosts are forming, and you are the reason. Their roads end at this gate.",
    incomingCastleThreat:
 ...
 */
export function throughLine(axis: Axis, act: Act, mood: Mood, theme: Theme = "medieval"): string {
...
export const cairnReport = {
  ...
  buildingsImproved: (names: string[]): string => `Raised higher in your absence: ${list(names)}.`,
  ...
  unitsGained: (n: number): string =>
    n === 1 ? "One more came up the road and stayed." : `${n} more came up the road and stayed.`,
