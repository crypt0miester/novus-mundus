...
pub fn process(
    ...
    contributor.defensive_unit_1 = contributor
        .defensive_unit_1
        .saturating_add(garrison.units_1);
    contributor.defensive_unit_2 = contributor
        .defensive_unit_2
        .saturating_add(garrison.units_2);
    contributor.defensive_unit_3 = contributor
        .defensive_unit_3
        .saturating_add(garrison.units_3);

    // Return weapons to contributor
    contributor.melee_weapons = contributor
        .melee_weapons
        .saturating_add(garrison.melee_weapons);
    contributor.ranged_weapons = contributor
        .ranged_weapons
        .saturating_add(garrison.ranged_weapons);
    contributor.siege_weapons = contributor
        .siege_weapons
        .saturating_add(garrison.siege_weapons);

    // Return any loot to contributor
    contributor.melee_weapons = contributor
        .melee_weapons
        .saturating_add(garrison.loot_melee);
    contributor.ranged_weapons = contributor
        .ranged_weapons
        .saturating_add(garrison.loot_ranged);
    contributor.siege_weapons = contributor
        .siege_weapons
        .saturating_add(garrison.loot_siege);
