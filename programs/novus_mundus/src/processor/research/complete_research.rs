...
pub fn process(
    ...
    // 1. Parse accounts
    crate::extract_accounts!(accounts, exact [payer, research_progress, player_account, research_template]);
    ...
    player.set_research_buff_version(player.research_buff_version().wrapping_add(1));
