...
pub fn process(
    ...
    // 1. Parse Accounts
    crate::extract_accounts!(accounts, exact [owner, player_account, hero_mint, hero_template, hero_collection, game_engine, system_program, estate_account, p_core_program]);
