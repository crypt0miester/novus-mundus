...
pub struct EstateAccount {
    ...
    pub blessed_hero: Pubkey,              // From Sanctuary mini-game
    ...
    pub fn recalculate_buffs(&mut self) {
        ...
        for i in 0..self.max_slots() {
            ...
            match BuildingType::from_u8(building.building_type) {
                ...
                Some(BuildingType::Sanctuary) => {
                    // Sanctuary: No direct buff, enables hero slots
                }
...
impl CraftedEquipmentAccount {
    ...
    pub fn init(owner: Pubkey, bump: u8) -> Self {
        Self {
            owner,
