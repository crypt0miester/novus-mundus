...
export const SWITCHBOARD_ON_DEMAND_PROGRAM_ID_DEVNET = address(
...
const PULL_FEED_DISCRIMINATOR = Uint8Array.from([
...
export async function fetchSwitchboardPrice(
  ...
  const feed = await fetchSwitchboardFeed(rpc, feedAddress);
