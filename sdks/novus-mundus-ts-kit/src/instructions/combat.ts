...
export function createAttackEncounterInstruction(
  ...
  const keys = [
    ...
    { pubkey: accounts.gameEngine, isSigner: false, isWritable: false },
    { pubkey: address('11111111111111111111111111111111'), isSigner: false, isWritable: false }, // system_program placeholder
    { pubkey: estate, isSigner: false, isWritable: false },
  ];

  // Replace system_program placeholder with actual program ID
  keys[4] = { pubkey: address('11111111111111111111111111111111'), isSigner: false, isWritable: false };
