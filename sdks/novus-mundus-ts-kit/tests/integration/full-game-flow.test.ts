...
describe('Full Game Flow Integration', () => {
  ...
  describe('Player Initialization', () => {
    it('should create and initialize a new player', async () => {
      ...
      expect(account!.owner).toBe(player.publicKey);
  ...
  describe('Hero Flow', () => {
    it('should mint and use a hero', async () => {
      ...
      expect(hero.owner).toBe(player.publicKey);
    });
    ...
    it('should lock and unlock a hero', async () => {
      ...
      const dummyTarget = (await generateKeyPairSigner()).address;
  ...
  describe('Cross-System Integration', () => {
    ...
    it('should support multiple players in same test', async () => {
      ...
      const addresses = new Set(players.map(p => p.publicKey));
