...
const GROWTH_RESEARCH: ResearchNode[] = [
  ...
  { researchType: 21, name: 'Mining Operations',    description: 'Unlocks vehicle-based mining and boosts its efficiency.', category: 2, maxLevel: 10, baseTimeSeconds: 1800, baseNoviCost: 10_000, buffType: 21, buffPerLevelBps: 1000, prerequisiteResearch: 29,  prerequisiteLevel: 5,  gemCostPerMinute: 2,  isActive: true },
  { researchType: 22, name: 'Fishing Industry',     description: 'Unlocks fishing produce multiplication and boosts efficiency.', category: 2, maxLevel: 10, baseTimeSeconds: 1800, baseNoviCost: 10_000, buffType: 22, buffPerLevelBps: 1000, prerequisiteResearch: 29,  prerequisiteLevel: 10, gemCostPerMinute: 2,  isActive: true },
