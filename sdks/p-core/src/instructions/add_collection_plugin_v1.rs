...
use super::add_plugin_v1::PluginData;

/// Add a plugin to an MPL Core Collection V1.
///
/// ### Accounts:
...
pub struct AddCollectionPluginV1<'a> {
...
impl AddCollectionPluginV1<'_> {
    ...
    pub fn invoke_signed(&self, signers: &[Signer]) -> ProgramResult {
        ...
        // Discriminator (3 for AddCollectionPluginV1)
        write_bytes(&mut instruction_data[offset..offset+1], &[3]);
        offset += 1;

        offset = super::add_plugin_v1::write_plugin_data(&mut instruction_data, offset, &self.plugin);
