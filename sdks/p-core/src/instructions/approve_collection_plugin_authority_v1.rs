...
/// Approve a plugin authority on an MPL Core Collection V1.
///
/// ### Accounts:
...
pub struct ApproveCollectionPluginAuthorityV1<'a> {
...
impl ApproveCollectionPluginAuthorityV1<'_> {
    #[inline(always)]
    ...
    pub fn invoke_signed(&self, signers: &[Signer]) -> ProgramResult {
        ...
        // Discriminator (9 for ApproveCollectionPluginAuthorityV1)
        write_bytes(&mut instruction_data[offset..offset+1], &[9]);
        offset += 1;
