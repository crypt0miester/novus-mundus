...
/// Remove a plugin from an MPL Core Collection V1.
///
/// ### Accounts:
...
pub struct RemoveCollectionPluginV1<'a> {
...
impl RemoveCollectionPluginV1<'_> {
    #[inline(always)]
    ...
    pub fn invoke_signed(&self, signers: &[Signer]) -> ProgramResult {
        ...
        write_bytes(&mut instruction_data[0..1], &[5]); // RemoveCollectionPluginV1 discriminator
