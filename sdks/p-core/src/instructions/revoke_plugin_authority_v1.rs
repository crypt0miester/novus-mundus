...
/// Revoke a plugin authority on an MPL Core Asset V1.
///
/// ### Accounts:
///   0. `[WRITE]` The asset
...
pub struct RevokePluginAuthorityV1<'a> {
...
impl RevokePluginAuthorityV1<'_> {
    #[inline(always)]
    ...
    pub fn invoke_signed(&self, signers: &[Signer]) -> ProgramResult {
        ...
        write_bytes(&mut instruction_data[0..1], &[10]); // RevokePluginAuthorityV1 discriminator
